...
.equ AccessoryEffectTester, OffsetList + 0x8
.equ RangeAccessoryList, OffsetList + 0xC
...
SkipSkillCheck:
	...
	cmp 	r3, #0x0
	beq 	DoItemEffects	@end loop is routine pointer is null
	mov 	r0, r4
	mov 	r1, r5
	mov 	r2, r6
	bl Jump_r3
	...
	b Loop
DoItemEffects:
	ldr r7, RangeAccessoryList
	Loop1:
	ldr 	r1, [r7]
	cmp 	r1, #0x0
	beq SkipAccessoryCheck
	mov 	r0, r4
	ldr 	r3, AccessoryEffectTester
	_blr r3
	cmp 	r0, #0x0
	beq Reloop1
SkipAccessoryCheck:
