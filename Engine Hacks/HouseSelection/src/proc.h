...
#pragma long_calls
extern struct Proc *ProcStart(const struct ProcCmd *script, struct Proc *parent);
extern struct Proc *ProcStartBlocking(const struct ProcCmd *script, struct Proc *parent);
extern void BreakProcLoop(struct Proc *proc);
extern struct Proc *ProcFind(const struct ProcCmd *script);
